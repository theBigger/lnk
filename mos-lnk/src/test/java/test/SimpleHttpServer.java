				...
				if (client != null) {
					...
					try {
						...
						if (resource.endsWith(".jpg")) {
							...
							out.println("<form method=post action='/path?qryParm=POST URL查询参数' > POST 表单 " + "<input name=username value='用户'> "
									+ "<input name=submit type=submit value=submit></form>");
							out.println("<form method=get action='/path?qryParm=GET URL查询参数' >&nbsp;GET 表单 " + "<input name=username value='用户'> "
									+ "<input name=submit type=submit value=submit></form>");
							...
							out.println("<form method=post action='/path?qryParm=POST URL查询参数'" + " enctype='multipart/form-data' >" + "文件上传&nbsp; <input type='file' name=file1 ><br>"
									...
									+ "<input name=username value='用户'> " + "<input name=submit type=submit value=submit></form>");
